...
We now focus on the sentiment that words in the speeches convey. We'll carry out word-level sentiment analysis using several lexicons. We are aware of the limitations of word-level sentiment analysis, but it serves our purpose of applying basic techniques.
