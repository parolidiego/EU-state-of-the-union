...
Other: correlation with phi coefficient on whether words tend to appear in the same speech? --> probably useless
--

-- 
Another addition could be look at specific words frequency over time
--
...
speeches_tf_idf |> 
  ...
  group_by(year) |> 
  slice_max(tf_idf)
#  efsf is European Financial Stability Facility
```

-- 
Comment + fix europe's and country's + look at some of these words in context to understand why they were used (ex. exist, sound, parties, 2019 patriotism, surprise, cyber)
--
...
--
Try to see if trigrams give some insights as well by loooking at their count and tf-idf
--
